    ...
    <header className={`container-fluid header `}>
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="container-fluid ">
          ...
          <a className="navbar-brand order-1 " href="#">Papyrus</a>

         
          <main className="main order-2 order-lg-4 ms-auto ">
            
   <button onClick={changemode} className={`btn btn-light me-2 iconsh `}>
              {darkmode ? "🌙" : "☀️"}
            </button>
            <div>
<button className="headernameanddiv" onClick={handlelogout}>
          ...
          {logoutdiv&&(
                <div className='logoutdiv'>
                    <div className='ldiv fluid-container'><i class="bi bi-person iconh"></i>Profile</div>
                    <div className='ldiv'><i class="bi bi-gear iconh"></i>Settings</div>
                    <hr className='line'/>
                    <div className='ldiv'><i class="bi bi-box-arrow-right iconh"></i>Signout</div>
                </div>
            )}
            </div>
</main>
